...
public class MatchingUserJoin {
	//이건 가정집이야
	//내가 펫시터야
	//로그인유저아이디는 나야,유저아이디는 너야, 시터아이디는 나야 가정집이야
	//내가 견주야
	//로긍니유저 아이디는 일단 나야 무조건 나야, 유저아이디도 나야 물론 나야, 시터아이디는 다른사람이야 가정집이야
	//
   ...
   public MatchingUserJoin(int match_No, String sitter_Id, String user_Id, String isHome, Date careDate, int price,
         String wantToSay, String special_Note, String thumbnail, String regStatus, String countPet, int userNo,
         String userName, String userEmail, String userPhone, String userAddress, int reported) {
      super();
   ...
   public String toString() {
      return "MatchingUserJoin [match_No=" + match_No + ", sitter_Id=" + sitter_Id + ", user_Id=" + user_Id
            + ", isHome=" + isHome + ", careDate=" + careDate + ", price=" + price + ", wantToSay=" + wantToSay
            + ", special_Note=" + special_Note + ", thumbnail=" + thumbnail + ", regStatus=" + regStatus
            + ", countPet=" + countPet + ", userNo=" + userNo + ", userName=" + userName + ", userEmail="
