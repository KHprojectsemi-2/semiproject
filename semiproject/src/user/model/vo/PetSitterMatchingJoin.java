...
public class PetSitterMatchingJoin {
	//여긴 방문이야
	
	//내가 펫시터
	//시터아이디는 나야, 로그인유저아이디가 나야, 유저아이디가 상대방이야 n 무적권 방문이야
	//니가 펫시터
	//시터아이디는 너야, 로그인유저아이디가 나야, 유저아이디가 나야 무적권 방문이야
	//
   ...
   //   1 - 매칭 안된상태 ( 주로 견주입장 )
   //   2 - 매칭은됐지만 해당날짜가 아직 안온상태 ( 펫시터 글올릴때 2여도 불러와야함 )
   //   3 - 매칭종료
