...
/**
 * Servlet implementation class IsPetSitter
 */
@WebServlet("/isPetSitter.pe")
public class IsPetSitter extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PetSitter ps = new MatchingService().isPetSitter(sitterId);
