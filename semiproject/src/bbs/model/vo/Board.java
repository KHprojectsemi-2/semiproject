...
public class Board implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3726899102214096368L;
	...
	// int cId와 int bWriter는 String형으로 바꾸자(이후에 조인한 결과값을 담을 꺼라서..)
	
	
	public Board() {
	}
	
	public Board(int bId, int bType, String cId, String bTitle, String bContent, String bWriter, int bCount,
	...
	public String toString() {
		return "Board [bId=" + bId + ", bType=" + bType + ", cId=" + cId + ", bTitle=" + bTitle + ", bContent="
