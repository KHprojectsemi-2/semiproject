...
<body>
   ...
   <form id="userUpdateForm" action="<%=request.getContextPath() %>/update.me" method="post">
      ...
      <div class = "abc" id="d_confirm" style = "display : inline-block;">
      ...
      <div id="d_confirm">
         ...
         <input type="text" id="userAddress" name="userAddress" value="<%=loginUser.getUserAddress()%>"  size="40" style="margin-left:103px">
         <input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" style="margin-left:103px"><br>
         ...
         <div class="petForm" id="petForm">
            <table style="width:100%;">
               <tr>
                  <td>
                     <div class="petConfirm_d" style="margin-left:40px">
                        <label class="petConfirm_l" style="width:120px">강아지 이름: </label>
