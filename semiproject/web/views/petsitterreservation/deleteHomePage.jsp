    	...
    	<div class="card" style="max-width: 1000px">
            ...
            <div class="col-md-7" align="center">
                <div class="card-body leftalign" style="width:700px">
                   ...
                   <p class="card-text sitterName" align="right"><%=mList.get(i).getUserName() %> 펫시터 님</p>
                   <br>
					...
					<input type="hidden" value=<%=mList.get(i).getMatch_No() %>>
                   	<ul class="blog-info-link">
                        <li>
                        	<input type="hidden" value="<%=mList.get(i).getSitter_Id() %>" class="hsitterid">
